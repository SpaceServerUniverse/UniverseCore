...
CREATE TABLE IF NOT EXISTS ore_counts(
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    count_id BIGINT UNSIGNED NOT NULL UNIQUE,
    coal_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    iron_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    gold_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    lapis_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    redstone_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    emerald_ore BIGINT UNSIGNED NOT NULL UNIQUE,
    diamond_ore BIGINT UNSIGNED NOT NULL UNIQUE,
